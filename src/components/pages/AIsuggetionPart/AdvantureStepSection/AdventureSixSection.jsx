    ...
    <div className=" heroBg text-white flex flex-col items-center justify-center ">
      <div className="container w-full lg:text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="w-full sm:w-auto px-8 py-4 bg-[#2a6d4f] hover:bg-[#1e4d38] rounded-2xl flex items-center justify-center gap-3 font-bold transition-all shadow-lg">
            <BiCheck size={24} />
