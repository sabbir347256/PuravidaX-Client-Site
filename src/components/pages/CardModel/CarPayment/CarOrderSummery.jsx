      ...
      <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-50 sticky top-8">
        ...
        <div className="space-y-4 mb-6">
          <div className="flex justify-between items-center text-sm">
            <span className="text-gray-500">Toyota RAV4 4x4</span>
            <span className="font-bold">$856</span>
          </div>
          <div className="flex justify-between items-center text-sm border-t pt-4">
            <span className="text-gray-500 text-xs">$55/day 7 days</span>
...
export default CarOrderSummery;
